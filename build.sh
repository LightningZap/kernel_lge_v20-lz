...
export KBUILD_BUILD_USER=Thomas.Raines
export KBUILD_BUILD_HOST=MainFrame
export CROSS_COMPILE="ccache /home/reddragon/aarch64-linux-gnu-8.x/bin/aarch64-linux-gnu-"
export ARCH=arm64
